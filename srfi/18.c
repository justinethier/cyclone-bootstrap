...
static void __lambda_24(void *data, int argc, closure _,object k_7321) ;
...
static void __lambda_23(void *data, int argc, closure _, object k, object obj) { object heap_obj = copy2heap(data, obj);
...
void c_srfi18_entry_pt(data, argc, cont,value) void *data; int argc; closure cont; object value;{ 
  ...
  mclosure0(c_73179, (function_type)__lambda_24);c_73179.num_args = 0; 
  ...
  make_cvar(cvar_73184, (object *)&__glo__91_125heap);make_cons(pair_73185, find_or_add_symbol("->heap"), &cvar_73184);
  make_cvar(cvar_73186, (object *)&__glo_thread_91yield_67);make_cons(pair_73187, find_or_add_symbol("thread-yield!"), &cvar_73186);
  make_cvar(cvar_73188, (object *)&__glo_thread_91start_67);make_cons(pair_73189, find_or_add_symbol("thread-start!"), &cvar_73188);
  make_cvar(cvar_73190, (object *)&__glo_thread_91specific_91set_67);make_cons(pair_73191, find_or_add_symbol("thread-specific-set!"), &cvar_73190);
  make_cvar(cvar_73192, (object *)&__glo_thread_91specific);make_cons(pair_73193, find_or_add_symbol("thread-specific"), &cvar_73192);
  make_cvar(cvar_73194, (object *)&__glo_thread_91name);make_cons(pair_73195, find_or_add_symbol("thread-name"), &cvar_73194);
  make_cvar(cvar_73196, (object *)&__glo_make_91thread);make_cons(pair_73197, find_or_add_symbol("make-thread"), &cvar_73196);
  make_cvar(cvar_73198, (object *)&__glo_thread_127);make_cons(pair_73199, find_or_add_symbol("thread?"), &cvar_73198);
make_cons(c_73200, &pair_73183,Cyc_global_variables);
make_cons(c_73201, &pair_73185, &c_73200);
make_cons(c_73202, &pair_73187, &c_73201);
make_cons(c_73203, &pair_73189, &c_73202);
make_cons(c_73204, &pair_73191, &c_73203);
make_cons(c_73205, &pair_73193, &c_73204);
make_cons(c_73206, &pair_73195, &c_73205);
make_cons(c_73207, &pair_73197, &c_73206);
make_cons(c_73208, &pair_73199, &c_73207);
Cyc_global_variables = &c_73208;
