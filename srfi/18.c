...
static void __lambda_25(void *data, int argc, closure _,object k_7321) ;
...
make_int(c_73182, 0);
return_closcall1(data,  k_7321,  &c_73182);; 
}
...
make_int(c_73177, 1);
return_closcall1(data,  k_7324,  Cyc_thread_sleep(data, &c_73177));; 
}
...
void c_srfi18_entry_pt(data, argc, cont,value) void *data; int argc; closure cont; object value;{ 
  ...
  mclosure0(c_73180, (function_type)__lambda_25);c_73180.num_args = 0; 
  __glo_lib_91init_117srfi18 = &c_73180; 
  mclosure0(c_73179, (function_type)__lambda_24);c_73179.num_args = 1; 
  __glo__91_125heap = &c_73179; 
  mclosure0(c_73178, (function_type)__lambda_23);c_73178.num_args = 1; 
  ...
  make_cvar(cvar_73183, (object *)&__glo_lib_91init_117srfi18);make_cons(pair_73184, find_or_add_symbol("lib-init:srfi18"), &cvar_73183);
  make_cvar(cvar_73185, (object *)&__glo__91_125heap);make_cons(pair_73186, find_or_add_symbol("->heap"), &cvar_73185);
  make_cvar(cvar_73187, (object *)&__glo_thread_91sleep_67);make_cons(pair_73188, find_or_add_symbol("thread-sleep!"), &cvar_73187);
  make_cvar(cvar_73189, (object *)&__glo_thread_91yield_67);make_cons(pair_73190, find_or_add_symbol("thread-yield!"), &cvar_73189);
  make_cvar(cvar_73191, (object *)&__glo_thread_91start_67);make_cons(pair_73192, find_or_add_symbol("thread-start!"), &cvar_73191);
  make_cvar(cvar_73193, (object *)&__glo_thread_91specific_91set_67);make_cons(pair_73194, find_or_add_symbol("thread-specific-set!"), &cvar_73193);
  make_cvar(cvar_73195, (object *)&__glo_thread_91specific);make_cons(pair_73196, find_or_add_symbol("thread-specific"), &cvar_73195);
  make_cvar(cvar_73197, (object *)&__glo_thread_91name);make_cons(pair_73198, find_or_add_symbol("thread-name"), &cvar_73197);
  make_cvar(cvar_73199, (object *)&__glo_make_91thread);make_cons(pair_73200, find_or_add_symbol("make-thread"), &cvar_73199);
  make_cvar(cvar_73201, (object *)&__glo_thread_127);make_cons(pair_73202, find_or_add_symbol("thread?"), &cvar_73201);
make_cons(c_73203, &pair_73184,Cyc_global_variables);
...
make_cons(c_73212, &pair_73202, &c_73211);
Cyc_global_variables = &c_73212;
