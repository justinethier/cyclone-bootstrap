...
static void __lambda_20(void *data, int argc, closure _,object k_7331) ;
static void __lambda_19(void *data, int argc, closure _,object k_7334, object format_91string_7312, object objects_7311_raw, ...) ;
static void __lambda_18(void *data, int argc, object self_7369, object buffer_7318, object fmt_91rec_7316) ;
static void __lambda_17(void *data, int argc, object self_7370, object buffer_7318) ;
static void __lambda_16(void *data, int argc, object self_7371, object fmt_91rec_7316) ;
static void __lambda_15(void *data, int argc, object self_7372, object r_7368) ;
static void __lambda_14(void *data, int argc, object self_7373, object r_7335) ;
static void __lambda_13(void *data, int argc, object self_7374, object k_7339, object format_91list_7322, object objs_7321) ;
static void __lambda_12(void *data, int argc, object self_7375, object escape_91write_7324, object raw_91write_7323) ;
static void __lambda_11(void *data, int argc, object self_7376, object escape_91write_7324) ;
static void __lambda_10(void *data, int argc, object self_7377, object raw_91write_7323) ;
static void __lambda_9(void *data, int argc, object self_7378, object k_7362, object how_7328) ;
static void __lambda_8(void *data, int argc, object self_7379, object r_7364) ;
static void __lambda_7(void *data, int argc, object self_7380, object r_7340) ;
static void __lambda_6(void *data, int argc, object self_7381, object k_7358, object what_7327, object next_7326) ;
static void __lambda_5(void *data, int argc, object self_7382, object r_7359) ;
static void __lambda_4(void *data, int argc, object self_7383, object r_7360) ;
static void __lambda_3(void *data, int argc, object self_7384, object r_7341) ;
static void __lambda_2(void *data, int argc, object self_7385, object r_7343) ;
static void __lambda_1(void *data, int argc, object self_7386, object r_7336) ;
static void __lambda_0(void *data, int argc, object self_7387, object r_7337) ;
...
c_7390.tag = closureN_tag;
 c_7390.fn = (function_type)__lambda_18;
c_7390.num_args = 2;
c_7390.num_elements = 3;
c_7390.elements = (object *)alloca(sizeof(object) * 3);
c_7390.elements[0] = format_91string_7312;
c_7390.elements[1] = k_7334;
c_7390.elements[2] = objects_7311;

return_closcall2(data,(closure)&c_7390,  boolean_f, boolean_f);; 
}
...
c_7392.tag = closureN_tag;
 c_7392.fn = (function_type)__lambda_17;
c_7392.num_args = 1;
c_7392.num_elements = 4;
c_7392.elements = (object *)alloca(sizeof(object) * 4);
c_7392.elements[0] = fmt_91rec_7316;
c_7392.elements[1] = ((closureN)self_7369)->elements[0];
c_7392.elements[2] = ((closureN)self_7369)->elements[1];
c_7392.elements[3] = ((closureN)self_7369)->elements[2];


make_cell(c_73259,buffer_7318);
return_closcall1(data,(closure)&c_7392,  &c_73259);; 
}
...
c_7394.elements[0] = buffer_7318;
c_7394.elements[1] = ((closureN)self_7370)->elements[1];
c_7394.elements[2] = ((closureN)self_7370)->elements[2];
c_7394.elements[3] = ((closureN)self_7370)->elements[3];


make_cell(c_73255,((closureN)self_7370)->elements[0]);
return_closcall1(data,(closure)&c_7394,  &c_73255);; 
}
...
c_7396.num_args = 1;
c_7396.num_elements = 5;
c_7396.elements = (object *)alloca(sizeof(object) * 5);
c_7396.elements[0] = ((closureN)self_7371)->elements[0];
c_7396.elements[1] = fmt_91rec_7316;
c_7396.elements[2] = ((closureN)self_7371)->elements[1];
c_7396.elements[3] = ((closureN)self_7371)->elements[2];
c_7396.elements[4] = ((closureN)self_7371)->elements[3];

return_closcall1(data,  __glo_open_91output_91string_scheme_base,  &c_7396);; 
}
...
c_7398.elements[0] = ((closureN)self_7372)->elements[0];
c_7398.elements[1] = ((closureN)self_7372)->elements[1];
c_7398.elements[2] = ((closureN)self_7372)->elements[2];
c_7398.elements[3] = ((closureN)self_7372)->elements[3];
c_7398.elements[4] = ((closureN)self_7372)->elements[4];

return_closcall1(data,(closure)&c_7398,  Cyc_set_cell(data, ((closureN)self_7372)->elements[0], r_7368));; 
}
...
c_73100.tag = closureN_tag;
 c_73100.fn = (function_type)__lambda_1;
c_73100.num_args = 1;
c_73100.num_elements = 4;
c_73100.elements = (object *)alloca(sizeof(object) * 4);
c_73100.elements[0] = ((closureN)self_7373)->elements[1];
c_73100.elements[1] = ((closureN)self_7373)->elements[2];
c_73100.elements[2] = ((closureN)self_7373)->elements[3];
c_73100.elements[3] = ((closureN)self_7373)->elements[4];
...
c_73113.tag = closureN_tag;
 c_73113.fn = (function_type)__lambda_13;
c_73113.num_args = 2;
c_73113.num_elements = 2;
c_73113.elements = (object *)alloca(sizeof(object) * 2);
c_73113.elements[0] = ((closureN)self_7373)->elements[0];
c_73113.elements[1] = ((closureN)self_7373)->elements[1];

return_closcall1(data,(closure)&c_73100,  Cyc_set_cell(data, ((closureN)self_7373)->elements[1], &c_73113));; 
}
...
c_73115.tag = closureN_tag;
 c_73115.fn = (function_type)__lambda_12;
c_73115.num_args = 2;
c_73115.num_elements = 5;
c_73115.elements = (object *)alloca(sizeof(object) * 5);
c_73115.elements[0] = ((closureN)self_7374)->elements[0];
c_73115.elements[1] = ((closureN)self_7374)->elements[1];
c_73115.elements[2] = format_91list_7322;
c_73115.elements[3] = k_7339;
c_73115.elements[4] = objs_7321;

return_closcall2(data,(closure)&c_73115,  boolean_f, boolean_f);; 
}
...
c_73117.elements[0] = ((closureN)self_7375)->elements[0];
c_73117.elements[1] = ((closureN)self_7375)->elements[1];
c_73117.elements[2] = ((closureN)self_7375)->elements[2];
c_73117.elements[3] = ((closureN)self_7375)->elements[3];
c_73117.elements[4] = ((closureN)self_7375)->elements[4];
c_73117.elements[5] = raw_91write_7323;


make_cell(c_73249,escape_91write_7324);
return_closcall1(data,(closure)&c_73117,  &c_73249);; 
}
...
c_73119.tag = closureN_tag;
 c_73119.fn = (function_type)__lambda_10;
c_73119.num_args = 1;
c_73119.num_elements = 6;
c_73119.elements = (object *)alloca(sizeof(object) * 6);
c_73119.elements[0] = ((closureN)self_7376)->elements[0];
c_73119.elements[1] = escape_91write_7324;
c_73119.elements[2] = ((closureN)self_7376)->elements[1];
c_73119.elements[3] = ((closureN)self_7376)->elements[2];
c_73119.elements[4] = ((closureN)self_7376)->elements[3];
c_73119.elements[5] = ((closureN)self_7376)->elements[4];


make_cell(c_73245,((closureN)self_7376)->elements[5]);
return_closcall1(data,(closure)&c_73119,  &c_73245);; 
}
...
c_73121.num_args = 1;
c_73121.num_elements = 7;
c_73121.elements = (object *)alloca(sizeof(object) * 7);
c_73121.elements[0] = ((closureN)self_7377)->elements[0];
c_73121.elements[1] = ((closureN)self_7377)->elements[1];
c_73121.elements[2] = ((closureN)self_7377)->elements[2];
c_73121.elements[3] = ((closureN)self_7377)->elements[3];
c_73121.elements[4] = ((closureN)self_7377)->elements[4];
c_73121.elements[5] = ((closureN)self_7377)->elements[5];
c_73121.elements[6] = raw_91write_7323;
...
c_73218.tag = closureN_tag;
 c_73218.fn = (function_type)__lambda_9;
c_73218.num_args = 1;
...
return_closcall1(data,(closure)&c_73121,  Cyc_set_cell(data, ((closureN)self_7377)->elements[1], &c_73218));; 
}
...
c_73123.num_args = 1;
c_73123.num_elements = 5;
c_73123.elements = (object *)alloca(sizeof(object) * 5);
c_73123.elements[0] = ((closureN)self_7380)->elements[0];
c_73123.elements[1] = ((closureN)self_7380)->elements[1];
c_73123.elements[2] = ((closureN)self_7380)->elements[3];
c_73123.elements[3] = ((closureN)self_7380)->elements[4];
c_73123.elements[4] = ((closureN)self_7380)->elements[6];
...
c_73199.tag = closureN_tag;
 c_73199.fn = (function_type)__lambda_6;
c_73199.num_args = 2;
...
return_closcall1(data,(closure)&c_73123,  Cyc_set_cell(data, ((closureN)self_7380)->elements[6], &c_73199));; 
}
...
c_73201.tag = closureN_tag;
 c_73201.fn = (function_type)__lambda_5;
c_73201.num_args = 1;
...
c_73133.num_args = 1;
c_73133.num_elements = 4;
c_73133.elements = (object *)alloca(sizeof(object) * 4);
c_73133.elements[0] = ((closureN)self_7384)->elements[1];
c_73133.elements[1] = ((closureN)self_7384)->elements[2];
c_73133.elements[2] = ((closureN)self_7384)->elements[3];
c_73133.elements[3] = ((closureN)self_7384)->elements[4];

return_closcall3(data,  __glo_char_123_127_scheme_base,  &c_73133, Cyc_car(data, ((closureN)self_7384)->elements[2]), obj_char2obj(126));}
; 
}

static void __lambda_2(void *data, int argc, object self_7385, object r_7343) {
  if( (boolean_f != r_7343) ){ 
  if( (boolean_f != Cyc_is_null(Cyc_cdr(data, ((closureN)self_7385)->elements[1]))) ){ 
  
make_string(c_73141, "Incomplete escape sequence");
return_closcall2(data,  __glo_error_scheme_base,  ((closureN)self_7385)->elements[2], &c_73141);
} else { 
  if( (boolean_f != Cyc_eq(Cyc_cadr(data, ((closureN)self_7385)->elements[1]), obj_char2obj(97))) ){ 
  return_closcall2(data,  cell_get(((closureN)self_7385)->elements[0]),  ((closureN)self_7385)->elements[2], __glo_display_scheme_write);
} else { 
  if( (boolean_f != Cyc_eq(Cyc_cadr(data, ((closureN)self_7385)->elements[1]), obj_char2obj(115))) ){ 
  return_closcall2(data,  cell_get(((closureN)self_7385)->elements[0]),  ((closureN)self_7385)->elements[2], __glo_write_scheme_write);
} else { 
  if( (boolean_f != Cyc_eq(Cyc_cadr(data, ((closureN)self_7385)->elements[1]), obj_char2obj(37))) ){ 
  return_closcall3(data,  cell_get(((closureN)self_7385)->elements[3]),  ((closureN)self_7385)->elements[2], obj_char2obj(10), primitive_cddr);
} else { 
  if( (boolean_f != Cyc_eq(Cyc_cadr(data, ((closureN)self_7385)->elements[1]), obj_char2obj(126))) ){ 
  return_closcall3(data,  cell_get(((closureN)self_7385)->elements[3]),  ((closureN)self_7385)->elements[2], obj_char2obj(126), primitive_cddr);
} else { 
  
make_string(c_73184, "Unrecognized escape sequence");
return_closcall2(data,  __glo_error_scheme_base,  ((closureN)self_7385)->elements[2], &c_73184);}
}
}
}
}
  ...
  return_closcall3(data,  cell_get(((closureN)self_7385)->elements[3]),  ((closureN)self_7385)->elements[2], Cyc_car(data, ((closureN)self_7385)->elements[1]), primitive_cdr);}
; 
}
...
c_73102.tag = closureN_tag;
 c_73102.fn = (function_type)__lambda_0;
c_73102.num_args = 1;
c_73102.num_elements = 3;
c_73102.elements = (object *)alloca(sizeof(object) * 3);
c_73102.elements[0] = ((closureN)self_7386)->elements[0];
c_73102.elements[1] = ((closureN)self_7386)->elements[2];
c_73102.elements[2] = ((closureN)self_7386)->elements[3];

return_closcall2(data,  __glo_string_91_125list_scheme_base,  &c_73102, ((closureN)self_7386)->elements[1]);; 
}

static void __lambda_0(void *data, int argc, object self_7387, object r_7337) {
  return_closcall3(data,  cell_get(((closureN)self_7387)->elements[0]),  ((closureN)self_7387)->elements[1], r_7337, ((closureN)self_7387)->elements[2]);; 
}
...
void c_srfi28_entry_pt(data, argc, cont,value) void *data; int argc; closure cont; object value;{ 
  ...
  mclosure0(c_73260, (function_type)__lambda_20);c_73260.num_args = 0; 
  __glo_lib_91init_117srfi28_srfi_28 = &c_73260; 
  mclosure0(c_7388, (function_type)__lambda_19);c_7388.num_args = 1; 
  __glo_format_srfi_28 = &c_7388; 
