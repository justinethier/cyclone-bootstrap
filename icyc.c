...
mclosure1(c_73207, c_schemecxr_entry_pt, &c_73206);
mclosure1(c_73208, c_schemelazy_entry_pt, &c_73207);
mclosure1(c_73209, c_schemeload_entry_pt, &c_73208);
mclosure1(c_73210, c_schemeeval_entry_pt, &c_73209);
mclosure1(c_73211, c_schemeread_entry_pt, &c_73210);
mclosure1(c_73212, c_schemecycloneutil_entry_pt, &c_73211);
mclosure1(c_73213, c_schemefile_entry_pt, &c_73212);
mclosure1(c_73214, c_schemeinexact_entry_pt, &c_73213);
mclosure1(c_73215, c_schemeprocess_91context_entry_pt, &c_73214);
mclosure1(c_73216, c_schemetime_entry_pt, &c_73215);
mclosure1(c_73217, c_srfi69_entry_pt, &c_73216);
mclosure1(c_73218, c_scheme_char_entry_pt, &c_73217);
mclosure1(c_73219, c_schemecomplex_entry_pt, &c_73218);
mclosure1(c_73220, c_schemebase_entry_pt, &c_73219);
mclosure1(c_73221, c_schemecyclonecommon_entry_pt, &c_73220);
(c_73221.fn)(data, 0, &c_73221, &c_73221);
}
static void c_entry_pt_first_lambda(void *data, int argc, closure cont, object value) {
