...
mclosure1(c_731801, c_schemeeval_entry_pt, &c_731800);
mclosure1(c_731802, c_schemeread_entry_pt, &c_731801);
mclosure1(c_731803, c_schemefile_entry_pt, &c_731802);
mclosure1(c_731804, c_schemecycloneutil_entry_pt, &c_731803);
mclosure1(c_731805, c_scheme_char_entry_pt, &c_731804);
mclosure1(c_731806, c_schemewrite_entry_pt, &c_731805);
mclosure1(c_731807, c_schemebase_entry_pt, &c_731806);
(c_731807.fn)(data, 0, &c_731807, &c_731807);
}
static void c_entry_pt_first_lambda(void *data, int argc, closure cont, object value) {
