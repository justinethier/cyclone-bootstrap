...
static void __lambda_23(int argc, closure _,object k_7316) ;
static void __lambda_22(int argc, closure _,object k_7319, object str_734) ;
static void __lambda_21(int argc, closure _,object k_7322, object str_735) ;
static void __lambda_20(int argc, closure _,object k_7325, object c_736) ;
static void __lambda_19(int argc, object self_7360, object r_7326) ;
static void __lambda_18(int argc, object self_7361, object r_7327) ;
static void __lambda_17(int argc, closure _,object k_7330, object c_737) ;
static void __lambda_16(int argc, object self_7362, object r_7331) ;
static void __lambda_15(int argc, closure _,object k_7334, object c_738) ;
static void __lambda_14(int argc, object self_7363, object r_7335) ;
static void __lambda_13(int argc, closure _,object k_7338, object c_739) ;
static void __lambda_12(int argc, object self_7364, object r_7339) ;
static void __lambda_11(int argc, closure _,object k_7342, object c_7310) ;
static void __lambda_10(int argc, object self_7365, object r_7343) ;
static void __lambda_9(int argc, closure _,object k_7346, object c_7311) ;
static void __lambda_8(int argc, object self_7366, object r_7347) ;
static void __lambda_7(int argc, closure _,object k_7350, object c_7312) ;
static void __lambda_6(int argc, object self_7367, object r_7351) ;
static void __lambda_5(int argc, object self_7368, object r_7353) ;
static void __lambda_4(int argc, object self_7369, object r_7352) ;
static void __lambda_3(int argc, closure _,object k_7356, object c_7313) ;
static void __lambda_2(int argc, object self_7370, object r_7357) ;
static void __lambda_1(int argc, object self_7371, object r_7359) ;
static void __lambda_0(int argc, object self_7372, object r_7358) ;

static void __lambda_23(int argc, closure _,object k_7316) {
  Cyc_st_add("scheme/char.sld:lib-init:scheme_char");

make_int(c_73194, 0);
return_closcall1(  k_7316,  &c_73194);; 
}

static void __lambda_22(int argc, closure _,object k_7319, object str_734) {
  Cyc_st_add("scheme/char.sld:string-downcase");
return_closcall3(  __glo_string_91map,  k_7319, __glo_char_91downcase, str_734);; 
}

static void __lambda_21(int argc, closure _,object k_7322, object str_735) {
  Cyc_st_add("scheme/char.sld:string-upcase");
return_closcall3(  __glo_string_91map,  k_7322, __glo_char_91upcase, str_735);; 
}
...
return_closcall2(  __glo_char_91numeric_127,  &c_73173, c_736);; 
}
...
return_closcall1((closure)&c_73175,  &c_73184);
} else { 
  return_closcall1(  ((closureN)self_7360)->elts[1],  boolean_f);}
; 
}
...
common_type c_73180 = Cyc_sub(2,r_7327, &c_73181);
return_closcall1(  ((closureN)self_7361)->elts[0],  &c_73180);; 
}
...
return_closcall1((closure)&c_73161,  &c_73167);; 
}

static void __lambda_16(int argc, object self_7362, object r_7331) {
  Cyc_st_add("scheme/char.sld:char-whitespace?");
return_closcall1(  ((closureN)self_7362)->elts[1],  memberp(((closureN)self_7362)->elts[0], r_7331));; 
}
...
return_closcall1((closure)&c_73143,  &c_73149);; 
}

static void __lambda_14(int argc, object self_7363, object r_7335) {
  Cyc_st_add("scheme/char.sld:char-numeric?");
return_closcall1(  ((closureN)self_7363)->elts[1],  memberp(((closureN)self_7363)->elts[0], r_7335));; 
}
...
return_closcall3(  __glo_char_125_123_127,  &c_73135, c_739, obj_char2obj(97));; 
}

static void __lambda_12(int argc, object self_7364, object r_7339) {
  Cyc_st_add("scheme/char.sld:char-lower-case?");
if( !eq(boolean_f, r_7339) ){ 
  return_closcall3(  __glo_char_121_123_127,  ((closureN)self_7364)->elts[1], ((closureN)self_7364)->elts[0], obj_char2obj(122));
} else { 
  return_closcall1(  ((closureN)self_7364)->elts[1],  boolean_f);}
; 
}
...
return_closcall3(  __glo_char_125_123_127,  &c_73127, c_7310, obj_char2obj(65));; 
}

static void __lambda_10(int argc, object self_7365, object r_7343) {
  Cyc_st_add("scheme/char.sld:char-upper-case?");
if( !eq(boolean_f, r_7343) ){ 
  return_closcall3(  __glo_char_121_123_127,  ((closureN)self_7365)->elts[1], ((closureN)self_7365)->elts[0], obj_char2obj(90));
} else { 
  return_closcall1(  ((closureN)self_7365)->elts[1],  boolean_f);}
; 
}
...
return_closcall3(  __glo_char_125_123_127,  &c_73119, c_7311, obj_char2obj(65));; 
}

static void __lambda_8(int argc, object self_7366, object r_7347) {
  Cyc_st_add("scheme/char.sld:char-alphabetic?");
if( !eq(boolean_f, r_7347) ){ 
  return_closcall3(  __glo_char_121_123_127,  ((closureN)self_7366)->elts[1], ((closureN)self_7366)->elts[0], obj_char2obj(122));
} else { 
  return_closcall1(  ((closureN)self_7366)->elts[1],  boolean_f);}
; 
}
...
return_closcall2(  __glo_char_91upper_91case_127,  &c_7397, c_7312);; 
}
...
return_closcall1((closure)&c_7399,  &c_73112);
} else { 
...
common_type c_73108 = Cyc_sum(2,r_7353, &c_73109);
return_closcall1((closure)&c_73101,  &c_73108);; 
}

static void __lambda_4(int argc, object self_7369, object r_7352) {
  Cyc_st_add("scheme/char.sld:char-downcase");
return_closcall1(  ((closureN)self_7369)->elts[0],  Cyc_integer2char(r_7352));; 
}
...
return_closcall2(  __glo_char_91lower_91case_127,  &c_7375, c_7313);; 
}
...
return_closcall1((closure)&c_7377,  &c_7390);
} else { 
  return_closcall1(  ((closureN)self_7370)->elts[1],  ((closureN)self_7370)->elts[0]);}
; 
}
...
common_type c_7386 = Cyc_sub(2,r_7359, &c_7387);
return_closcall1((closure)&c_7379,  &c_7386);; 
}

static void __lambda_0(int argc, object self_7372, object r_7358) {
  Cyc_st_add("scheme/char.sld:char-upcase");
return_closcall1(  ((closureN)self_7372)->elts[0],  Cyc_integer2char(r_7358));; 
}
