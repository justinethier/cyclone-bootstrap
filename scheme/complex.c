...
static void __lambda_37(void *data, int argc, closure _,object k_7352) ;
static void __lambda_36(void *data, int argc, closure _, object k, object r, object i) ;
...
static void __lambda_33(void *data, int argc, closure _,object k_7349, object x_737_7315, object y_738_7316) ;
static void __lambda_32(void *data, int argc, closure _,object k_7342, object r_735_7313, object phi_736_7314) ;
static void __lambda_31(void *data, int argc, object self_7361, object r_7346) ;
static void __lambda_30(void *data, int argc, object self_7362, object r_7345) ;
static void __lambda_29(void *data, int argc, closure _,object k_7337, object z_734_7312) ;
static void __lambda_28(void *data, int argc, object self_7359, object r_7338) ;
static void __lambda_27(void *data, int argc, object self_7360, object r_7339) ;
static void __lambda_26(void *data, int argc, closure _,object k_7327, object z_733_7311) ;
static void __lambda_25(void *data, int argc, object self_7355, object r_7333) ;
static void __lambda_24(void *data, int argc, object self_7356, object r_7334) ;
static void __lambda_23(void *data, int argc, object self_7357, object r_7331) ;
static void __lambda_22(void *data, int argc, object self_7358, object r_7332) ;
static void __lambda_21(void *data, int argc, closure _,object k_7323, object x_732_7310) ;
static void __lambda_20(void *data, int argc, object self_7354, object r_7324) ;
static void __lambda_19(void *data, int argc, closure _,object k_7319, object x_731_739) ;
static void __lambda_18(void *data, int argc, object self_7353, object r_7320) ;
...
static void __lambda_36(void *data, int argc, closure _, object k, object r, object i) { Cyc_check_num(data, r);
        Cyc_check_num(data, i);
        Cyc_make_rectangular(data, k, r, i);  }
static void __lambda_35(void *data, int argc, closure _, object k, object z) { make_double(d, cimag(complex_num_value(z)));
        return_closcall1(data, k, &d);  }
static void __lambda_34(void *data, int argc, closure _, object k, object z) { make_double(d, creal(complex_num_value(z)));
        return_closcall1(data, k, &d);  }
static void __lambda_33(void *data, int argc, closure _,object k_7349, object x_737_7315, object y_738_7316) {
...
c_73132.tag = closureN_tag;
 c_73132.fn = (function_type)__lambda_31;
c_73132.num_args = 1;
c_73132.num_elements = 3;
c_73132.elements = (object *)alloca(sizeof(object) * 3);
c_73132.elements[0] = k_7342;
c_73132.elements[1] = phi_736_7314;
c_73132.elements[2] = r_735_7313;

return_closcall2(data,  __glo_cos_scheme_inexact,  &c_73132, phi_736_7314);; 
}
...
c_73134.tag = closureN_tag;
 c_73134.fn = (function_type)__lambda_30;
c_73134.num_args = 1;
c_73134.num_elements = 3;
c_73134.elements = (object *)alloca(sizeof(object) * 3);
c_73134.elements[0] = ((closureN)self_7361)->elements[0];
c_73134.elements[1] = r_7346;
c_73134.elements[2] = ((closureN)self_7361)->elements[2];

return_closcall2(data,  __glo_sin_scheme_inexact,  &c_73134, ((closureN)self_7361)->elements[1]);; 
}

static void __lambda_30(void *data, int argc, object self_7362, object r_7345) {
  
complex_num_type local_73139; object c_73140 = Cyc_fast_mul(data,&local_73139,((closureN)self_7362)->elements[2], ((closureN)self_7362)->elements[1]);

complex_num_type local_73145; object c_73146 = Cyc_fast_mul(data,&local_73145,((closureN)self_7362)->elements[2], r_7345);
return_closcall3(data,  __glo__75make_91rect_scheme_complex,  ((closureN)self_7362)->elements[0], c_73140, c_73146);; 
}
...
c_73123.tag = closureN_tag;
 c_73123.fn = (function_type)__lambda_28;
c_73123.num_args = 1;
...
c_73125.tag = closureN_tag;
 c_73125.fn = (function_type)__lambda_27;
c_73125.num_args = 1;
...
c_7390.tag = closureN_tag;
 c_7390.fn = (function_type)__lambda_25;
c_7390.num_args = 1;
...
c_7392.tag = closureN_tag;
 c_7392.fn = (function_type)__lambda_24;
c_7392.num_args = 1;
...
c_7394.tag = closureN_tag;
 c_7394.fn = (function_type)__lambda_23;
c_7394.num_args = 1;
...
c_7396.tag = closureN_tag;
 c_7396.fn = (function_type)__lambda_22;
c_7396.num_args = 1;
...
complex_num_type local_73109; object c_73110 = Cyc_fast_mul(data,&local_73109,((closureN)self_7358)->elements[2], ((closureN)self_7358)->elements[3]);

complex_num_type local_73115; object c_73116 = Cyc_fast_mul(data,&local_73115,((closureN)self_7358)->elements[1], r_7332);

complex_num_type local_73105; object c_73106 = Cyc_fast_sum(data,&local_73105,c_73110, c_73116);

complex_num_type local_73101; object c_73102 = ((inline_function_type)
                   ((closure)__glo_sqrt_191_191inline_191_191_scheme_base)->fn)(data,&local_73101,c_73106);
return_closcall1(data,  ((closureN)self_7358)->elements[0],  c_73102);; 
}
...
c_7378.tag = closureN_tag;
 c_7378.fn = (function_type)__lambda_20;
c_7378.num_args = 1;
...
c_7365.tag = closureN_tag;
 c_7365.fn = (function_type)__lambda_18;
c_7365.num_args = 1;
...
Cyc_set_globals_changed((gc_thread_data *)data);
  ...
  mclosure0(c_73154, (function_type)__lambda_37);c_73154.num_args = 0; 
  __glo_lib_91init_117schemecomplex_scheme_complex = &c_73154; 
  mclosure0(c_73153, (function_type)__lambda_36);c_73153.num_args = 2; 
  __glo__75make_91rect_scheme_complex = &c_73153; 
  mclosure0(c_73152, (function_type)__lambda_35);c_73152.num_args = 1; 
  __glo__75imag_91part_scheme_complex = &c_73152; 
  mclosure0(c_73151, (function_type)__lambda_34);c_73151.num_args = 1; 
  ...
  mclosure0(c_73130, (function_type)__lambda_32);c_73130.num_args = 2; 
  __glo_make_91polar_scheme_complex = &c_73130; 
  mclosure0(c_73121, (function_type)__lambda_29);c_73121.num_args = 1; 
  __glo_angle_scheme_complex = &c_73121; 
  mclosure0(c_7388, (function_type)__lambda_26);c_7388.num_args = 1; 
  __glo_magnitude_scheme_complex = &c_7388; 
  mclosure0(c_7376, (function_type)__lambda_21);c_7376.num_args = 1; 
  __glo_imag_91part_scheme_complex = &c_7376; 
  mclosure0(c_7363, (function_type)__lambda_19);c_7363.num_args = 1; 
...
make_pair(c_73188, &pair_73156,Cyc_global_variables);
make_pair(c_73187, &pair_73159, &c_73188);
make_pair(c_73186, &pair_73161, &c_73187);
make_pair(c_73185, &pair_73163, &c_73186);
make_pair(c_73184, &pair_73165, &c_73185);
make_pair(c_73183, &pair_73167, &c_73184);
