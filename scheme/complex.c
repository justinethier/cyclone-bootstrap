...
static void __lambda_15(void *data, int argc, closure _,object k_7352) ;
...
static void __lambda_14(void *data, int argc, closure _,object k_7349, object x_737_7315, object y_738_7316) ;
static void __lambda_11(void *data, int argc, closure _,object k_7342, object r_735_7313, object phi_736_7314) ;
static void __lambda_12(void *data, int argc, object self_7359, object r_7346) ;
static void __lambda_13(void *data, int argc, object self_7360, object r_7345) ;
static void __lambda_8(void *data, int argc, closure _,object k_7337, object z_734_7312) ;
static void __lambda_9(void *data, int argc, object self_7357, object r_7338) ;
static void __lambda_10(void *data, int argc, object self_7358, object r_7339) ;
static void __lambda_3(void *data, int argc, closure _,object k_7327, object z_733_7311) ;
static void __lambda_4(void *data, int argc, object self_7353, object r_7333) ;
static void __lambda_5(void *data, int argc, object self_7354, object r_7334) ;
static void __lambda_6(void *data, int argc, object self_7355, object r_7331) ;
static void __lambda_7(void *data, int argc, object self_7356, object r_7332) ;
static void __lambda_2(void *data, int argc, closure _,object k_7323, object x_732_7310) ;
...
c_73123.elements = (object *)e_73139;
c_73123.elements[0] = k_7342;
c_73123.elements[1] = phi_736_7314;
c_73123.elements[2] = r_735_7313;

return_closcall2(data,  __glo_cos_scheme_inexact,  &c_73123, phi_736_7314);; 
}
...
c_73125.elements = (object *)e_73137;
c_73125.elements[0] = ((closureN)self_7359)->elements[0];
c_73125.elements[1] = r_7346;
c_73125.elements[2] = ((closureN)self_7359)->elements[2];

return_closcall2(data,  __glo_sin_scheme_inexact,  &c_73125, ((closureN)self_7359)->elements[1]);; 
}

static void __lambda_13(void *data, int argc, object self_7360, object r_7345) {
  
complex_num_type local_73130; 

complex_num_type local_73135; 
return_closcall3(data,  __glo__75make_91rect_scheme_complex,  ((closureN)self_7360)->elements[0], Cyc_fast_mul(data,&local_73130, ((closureN)self_7360)->elements[2], ((closureN)self_7360)->elements[1]), Cyc_fast_mul(data,&local_73135, ((closureN)self_7360)->elements[2], r_7345));; 
}
...
c_73112.tag = closureN_tag;
 c_73112.fn = (function_type)__lambda_9;
c_73112.num_args = 1;
c_73112.num_elements = 2;
c_73112.elements = (object *)e_73120;
c_73112.elements[0] = k_7337;
c_73112.elements[1] = z_734_7312;

return_closcall2(data,  __glo_imag_91part_scheme_complex,  &c_73112, z_734_7312);; 
}
...
c_73114.elements = (object *)e_73118;
c_73114.elements[0] = ((closureN)self_7357)->elements[0];
c_73114.elements[1] = r_7338;

return_closcall2(data,  __glo_real_91part_scheme_complex,  &c_73114, ((closureN)self_7357)->elements[1]);; 
}

static void __lambda_10(void *data, int argc, object self_7358, object r_7339) {
  return_closcall3(data,  __glo_atan_scheme_inexact,  ((closureN)self_7358)->elements[0], ((closureN)self_7358)->elements[1], r_7339);; 
}
...
c_7379.elements = (object *)e_73109;
c_7379.elements[0] = k_7327;
c_7379.elements[1] = z_733_7311;

return_closcall2(data,  __glo_real_91part_scheme_complex,  &c_7379, z_733_7311);; 
}
...
c_7381.num_args = 1;
c_7381.num_elements = 3;
c_7381.elements = (object *)e_73107;
c_7381.elements[0] = ((closureN)self_7353)->elements[0];
c_7381.elements[1] = r_7333;
c_7381.elements[2] = ((closureN)self_7353)->elements[1];

return_closcall2(data,  __glo_real_91part_scheme_complex,  &c_7381, ((closureN)self_7353)->elements[1]);; 
}
...
c_7383.tag = closureN_tag;
 c_7383.fn = (function_type)__lambda_6;
c_7383.num_args = 1;
c_7383.num_elements = 4;
c_7383.elements = (object *)e_73105;
c_7383.elements[0] = ((closureN)self_7354)->elements[0];
c_7383.elements[1] = ((closureN)self_7354)->elements[1];
c_7383.elements[2] = r_7334;
c_7383.elements[3] = ((closureN)self_7354)->elements[2];

return_closcall2(data,  __glo_imag_91part_scheme_complex,  &c_7383, ((closureN)self_7354)->elements[2]);; 
}
...
c_7385.tag = closureN_tag;
 c_7385.fn = (function_type)__lambda_7;
c_7385.num_args = 1;
c_7385.num_elements = 4;
c_7385.elements = (object *)e_73103;
c_7385.elements[0] = ((closureN)self_7355)->elements[0];
c_7385.elements[1] = r_7331;
c_7385.elements[2] = ((closureN)self_7355)->elements[1];
c_7385.elements[3] = ((closureN)self_7355)->elements[2];

return_closcall2(data,  __glo_imag_91part_scheme_complex,  &c_7385, ((closureN)self_7355)->elements[3]);; 
}

static void __lambda_7(void *data, int argc, object self_7356, object r_7332) {
  
complex_num_type local_7390; 

complex_num_type local_7393; 

complex_num_type local_7396; 

complex_num_type local_73101; 
return_closcall1(data,  ((closureN)self_7356)->elements[0],  ((inline_function_type)
                   ((closure)__glo_sqrt_191_191inline_191_191_scheme_base)->fn)(data,&local_7390, Cyc_fast_sum(data,&local_7393, Cyc_fast_mul(data,&local_7396, ((closureN)self_7356)->elements[2], ((closureN)self_7356)->elements[3]), Cyc_fast_mul(data,&local_73101, ((closureN)self_7356)->elements[1], r_7332))));; 
}

static void __lambda_2(void *data, int argc, closure _,object k_7323, object x_732_7310) {
  object r_7324;
  object local_7374 = alloca(sizeof(complex_num_type)); 
  Cyc_st_add(data, "scheme/complex.sld:imag-part");
r_7324 = ((inline_function_type)
                   ((closure)__glo_complex_127_191_191inline_191_191_scheme_base)->fn)(data,local_7374, x_732_7310);;if( (boolean_f != r_7324) ){ 
  return_closcall2(data,  __glo__75imag_91part_scheme_complex,  k_7323, x_732_7310);
} else { 
  return_closcall1(data,  k_7323,  obj_int2obj(0));}
;; 
}

static void __lambda_1(void *data, int argc, closure _,object k_7319, object x_731_739) {
  object r_7320;
  object local_7366 = alloca(sizeof(complex_num_type)); 
  Cyc_st_add(data, "scheme/complex.sld:real-part");
r_7320 = ((inline_function_type)
                   ((closure)__glo_complex_127_191_191inline_191_191_scheme_base)->fn)(data,local_7366, x_731_739);;if( (boolean_f != r_7320) ){ 
  return_closcall2(data,  __glo__75real_91part_scheme_complex,  k_7319, x_731_739);
} else { 
  return_closcall1(data,  k_7319,  x_731_739);}
;; 
}
...
Cyc_set_globals_changed((gc_thread_data *)data);
  ...
  mclosure0(c_73145, (function_type)__lambda_15);c_73145.num_args = 0; 
  __glo_lib_91init_117schemecomplex_scheme_complex = &c_73145; 
  mclosure0(c_73144, (function_type)__lambda_18);c_73144.num_args = 2; 
  __glo__75make_91rect_scheme_complex = &c_73144; 
  mclosure0(c_73143, (function_type)__lambda_17);c_73143.num_args = 1; 
  __glo__75imag_91part_scheme_complex = &c_73143; 
  mclosure0(c_73142, (function_type)__lambda_16);c_73142.num_args = 1; 
  __glo__75real_91part_scheme_complex = &c_73142; 
  mclosure0(c_73140, (function_type)__lambda_14);c_73140.num_args = 2; 
  __glo_make_91rectangular_scheme_complex = &c_73140; 
  mclosure0(c_73121, (function_type)__lambda_11);c_73121.num_args = 2; 
  __glo_make_91polar_scheme_complex = &c_73121; 
  mclosure0(c_73110, (function_type)__lambda_8);c_73110.num_args = 1; 
  __glo_angle_scheme_complex = &c_73110; 
  mclosure0(c_7377, (function_type)__lambda_3);c_7377.num_args = 1; 
  __glo_magnitude_scheme_complex = &c_7377; 
  mclosure0(c_7369, (function_type)__lambda_2);c_7369.num_args = 1; 
  __glo_imag_91part_scheme_complex = &c_7369; 
  mclosure0(c_7361, (function_type)__lambda_1);c_7361.num_args = 1; 
  __glo_real_91part_scheme_complex = &c_7361; 

  mclosure0(clo_73148, c_schemecomplex_inlinable_lambdas); make_pair(pair_73147, find_or_add_symbol("c_schemecomplex_inlinable_lambdas"), &clo_73148);
  make_cvar(cvar_73149, (object *)&__glo_lib_91init_117schemecomplex_scheme_complex);make_pair(pair_73150, find_or_add_symbol("lib-init:schemecomplex"), &cvar_73149);
  make_cvar(cvar_73151, (object *)&__glo__75make_91rect_scheme_complex);make_pair(pair_73152, find_or_add_symbol("%make-rect"), &cvar_73151);
  make_cvar(cvar_73153, (object *)&__glo__75imag_91part_scheme_complex);make_pair(pair_73154, find_or_add_symbol("%imag-part"), &cvar_73153);
  make_cvar(cvar_73155, (object *)&__glo__75real_91part_scheme_complex);make_pair(pair_73156, find_or_add_symbol("%real-part"), &cvar_73155);
  make_cvar(cvar_73157, (object *)&__glo_make_91rectangular_scheme_complex);make_pair(pair_73158, find_or_add_symbol("make-rectangular"), &cvar_73157);
  make_cvar(cvar_73159, (object *)&__glo_make_91polar_scheme_complex);make_pair(pair_73160, find_or_add_symbol("make-polar"), &cvar_73159);
  make_cvar(cvar_73161, (object *)&__glo_angle_scheme_complex);make_pair(pair_73162, find_or_add_symbol("angle"), &cvar_73161);
  make_cvar(cvar_73163, (object *)&__glo_magnitude_scheme_complex);make_pair(pair_73164, find_or_add_symbol("magnitude"), &cvar_73163);
  make_cvar(cvar_73165, (object *)&__glo_imag_91part_scheme_complex);make_pair(pair_73166, find_or_add_symbol("imag-part"), &cvar_73165);
  make_cvar(cvar_73167, (object *)&__glo_real_91part_scheme_complex);make_pair(pair_73168, find_or_add_symbol("real-part"), &cvar_73167);
make_pair(c_73179, &pair_73147,Cyc_global_variables);
make_pair(c_73178, &pair_73150, &c_73179);
make_pair(c_73177, &pair_73152, &c_73178);
make_pair(c_73176, &pair_73154, &c_73177);
make_pair(c_73175, &pair_73156, &c_73176);
make_pair(c_73174, &pair_73158, &c_73175);
make_pair(c_73173, &pair_73160, &c_73174);
make_pair(c_73172, &pair_73162, &c_73173);
make_pair(c_73171, &pair_73164, &c_73172);
make_pair(c_73170, &pair_73166, &c_73171);
make_pair(c_73169, &pair_73168, &c_73170);
Cyc_global_variables = &c_73169;
