...
static void __lambda_35(void *data, int argc, object self_73109, object r_7337) ;
...
mclosure0(c_73250, (function_type)__lambda_31);c_73250.num_args = 0;
...
c_73256.tag = closureN_tag;
 c_73256.fn = (function_type)__lambda_34;
c_73256.num_args = 1;
...
c_73258.tag = closureN_tag;
 c_73258.fn = (function_type)__lambda_35;
c_73258.num_args = 1;
...
return_direct_with_clo1(data,(closure)&c_73258,__lambda_35,  Cyc_is_eof_object(c_7313_7323));; 
}
...
return_direct_with_clo1(data,(closure)&c_73122,__lambda_39,  &c_73249);; 
}
...
return_direct_with_clo1(data,(closure)&c_73126,__lambda_7,  &c_73238);; 
}
...
c_73240.tag = closureN_tag;
 c_73240.fn = (function_type)__lambda_29;
c_73240.num_args = 1;
...
c_73242.tag = closureN_tag;
 c_73242.fn = (function_type)__lambda_30;
c_73242.num_args = 1;
...
c_73213.tag = closureN_tag;
 c_73213.fn = (function_type)__lambda_25;
c_73213.num_args = 1;
...
return_direct_with_clo1(data,(closure)&c_73167,__lambda_18,  &c_73213);
} else { 
...
mclosure0(c_73216, (function_type)__lambda_26);c_73216.num_args = 1;
...
c_73188.tag = closureN_tag;
 c_73188.fn = (function_type)__lambda_23;
c_73188.num_args = 1;
...
return_direct_with_clo1(data,(closure)&c_73177,__lambda_22,  &c_73188);; 
}
...
c_73190.tag = closureN_tag;
 c_73190.fn = (function_type)__lambda_24;
c_73190.num_args = 1;
...
return_direct_with_clo1(data,(closure)&c_73190,__lambda_24,  Cyc_cdr(data, car(((closureN)self_73102)->elements[1])));; 
}
