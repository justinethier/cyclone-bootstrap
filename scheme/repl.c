...
static void __lambda_38(void *data, int argc, closure _,object k_7326) ;
...
static void __lambda_35(void *data, int argc, object self_7377, object k_7334) ;
static void __lambda_34(void *data, int argc, object self_7378, object r_7335) ;
static void __lambda_33(void *data, int argc, object self_7379, object r_7340) ;
static void __lambda_32(void *data, int argc, object self_7380, object c_732_7319) ;
static void __lambda_31(void *data, int argc, object self_7381, object r_7337) ;
static void __lambda_30(void *data, int argc, object self_7382, object r_7338) ;
static void __lambda_29(void *data, int argc, object self_7383, object r_7339) ;
static void __lambda_28(void *data, int argc, object self_7384, object k_7341, object obj_737_7320) ;
static void __lambda_27(void *data, int argc, object self_7385, object obj_738_7321) ;
static void __lambda_26(void *data, int argc, object self_7386, object obj_738_7321) ;
static void __lambda_25(void *data, int argc, object self_7387, object r_7343) ;
static void __lambda_24(void *data, int argc, object self_7388, object r_7344) ;
static void __lambda_23(void *data, int argc, object self_7389, object r_7345) ;
static void __lambda_22(void *data, int argc, object self_7390, object r_7342) ;
static void __lambda_21(void *data, int argc, object self_7391, object k_7346) ;
static void __lambda_20(void *data, int argc, object self_7392, object r_7347) ;
static void __lambda_19(void *data, int argc, object self_7393, object r_7358) ;
...
static void __lambda_16(void *data, int argc, object self_7396, object r_7362) ;
static void __lambda_15(void *data, int argc, object self_7397, object k_7363) ;
static void __lambda_14(void *data, int argc, object self_7398, object r_7372) ;
static void __lambda_13(void *data, int argc, object self_7399, object r_7371) ;
static void __lambda_12(void *data, int argc, object self_73100, object r_7365) ;
static void __lambda_11(void *data, int argc, object self_73101, object r_7366) ;
static void __lambda_10(void *data, int argc, object self_73102, object r_7367) ;
static void __lambda_9(void *data, int argc, object self_73103, object k_7368) ;
static void __lambda_8(void *data, int argc, object self_73104, object r_7357) ;
static void __lambda_7(void *data, int argc, object self_73105, object r_7348) ;
static void __lambda_6(void *data, int argc, object self_73106, object r_7349) ;
...
static void __lambda_3(void *data, int argc, object self_73109, object r_7353) ;
static void __lambda_2(void *data, int argc, object self_73110, object k_7354) ;
static void __lambda_1(void *data, int argc, object self_73111, object r_7356) ;
static void __lambda_0(void *data, int argc, closure _,object k_7375) ;
...
c_73254.elements[0] = ((closureN)self_7378)->elements[0];
...
c_73256.elements[0] = ((closureN)self_7379)->elements[0];
...
c_73258.elements[0] = c_732_7319;
c_73258.elements[1] = ((closureN)self_7380)->elements[0];

return_closcall1(data,(closure)&c_73258,  Cyc_is_eof_object(c_732_7319));; 
}
...
return_closcall2(data,  __glo_display_scheme_write,  ((closureN)self_7381)->elements[1], &c_73261);
} else { 
...
c_73263.elements[0] = ((closureN)self_7381)->elements[1];

return_closcall2(data,  __glo_write_scheme_write,  &c_73263, ((closureN)self_7381)->elements[0]);}
; 
}
...
c_73265.elements[0] = ((closureN)self_7382)->elements[0];

return_closcall1(data,  __glo_newline_scheme_base,  &c_73265);; 
}

static void __lambda_29(void *data, int argc, object self_7383, object r_7339) {
  return_closcall1(data,  __glo_repl_scheme_repl,  ((closureN)self_7383)->elements[0]);; 
}
...
c_73120.elements[0] = ((closureN)self_7384)->elements[0];
c_73120.elements[1] = k_7341;

return_closcall1(data,(closure)&c_73120,  obj_737_7320);; 
}
...
c_73122.elements[0] = ((closureN)self_7385)->elements[0];
c_73122.elements[1] = ((closureN)self_7385)->elements[1];


make_cell(c_73249,obj_738_7321);
...
c_73124.elements[0] = ((closureN)self_7386)->elements[0];
c_73124.elements[1] = ((closureN)self_7386)->elements[1];
c_73124.elements[2] = obj_738_7321;
...
c_73126.elements[0] = ((closureN)self_7387)->elements[2];
...
c_73238.elements[0] = ((closureN)self_7387)->elements[0];
c_73238.elements[1] = ((closureN)self_7387)->elements[1];
...
c_73240.elements[0] = ((closureN)self_7388)->elements[0];
c_73240.elements[1] = ((closureN)self_7388)->elements[1];
...
c_73242.elements[0] = ((closureN)self_7389)->elements[0];
c_73242.elements[1] = ((closureN)self_7389)->elements[1];

return_closcall1(data,  __glo_repl_scheme_repl,  &c_73242);; 
}

static void __lambda_22(void *data, int argc, object self_7390, object r_7342) {
  return_closcall2(data,  ((closureN)self_7390)->elements[0],  ((closureN)self_7390)->elements[1], r_7342);; 
}
...
c_73128.elements[1] = ((closureN)self_7391)->elements[0];

return_closcall2(data,  __glo_error_91object_127_scheme_base,  &c_73128, car(((closureN)self_7391)->elements[0]));; 
}
...
c_73130.elements[0] = ((closureN)self_7392)->elements[0];
c_73130.elements[1] = ((closureN)self_7392)->elements[1];

return_closcall2(data,  __glo_error_91object_91message_scheme_base,  &c_73130, car(((closureN)self_7392)->elements[1]));
} else { 
...
c_73165.elements[0] = ((closureN)self_7392)->elements[0];
c_73165.elements[1] = ((closureN)self_7392)->elements[1];

return_closcall1(data,(closure)&c_73165,  Cyc_is_pair(car(((closureN)self_7392)->elements[1])));}
; 
}
...
c_73167.elements[0] = ((closureN)self_7393)->elements[1];
...
c_73213.elements[0] = ((closureN)self_7393)->elements[0];
c_73213.elements[1] = ((closureN)self_7393)->elements[1];

return_closcall1(data,(closure)&c_73167,  &c_73213);
} else { 
  return_closcall2(data,  __glo_display_scheme_write,  ((closureN)self_7393)->elements[0], car(((closureN)self_7393)->elements[1]));}
; 
}
...
return_closcall2(data,  __glo_write_scheme_write,  &c_73218, o_7316_7322);; 
}

static void __lambda_16(void *data, int argc, object self_7396, object r_7362) {
  
make_utf8_string_with_len(c_73221, " ", 1, 1);
return_closcall2(data,  __glo_display_scheme_write,  ((closureN)self_7396)->elements[0], &c_73221);; 
}
...
c_73169.elements[1] = ((closureN)self_7397)->elements[0];

return_closcall1(data,(closure)&c_73169,  Cyc_car(data, car(((closureN)self_7397)->elements[0])));; 
}
...
c_73173.elements[0] = ((closureN)self_7398)->elements[0];
c_73173.elements[1] = ((closureN)self_7398)->elements[1];

return_closcall1(data,(closure)&c_73173,  Cyc_car(data, car(((closureN)self_7398)->elements[1])));
} else { 
  return_closcall1(data,  ((closureN)self_7398)->elements[0],  boolean_f);}
; 
}
...
c_73175.elements[0] = ((closureN)self_7399)->elements[0];
c_73175.elements[1] = ((closureN)self_7399)->elements[1];
...
c_73177.elements[0] = ((closureN)self_73100)->elements[1];
...
c_73188.elements[0] = ((closureN)self_73100)->elements[0];
c_73188.elements[1] = ((closureN)self_73100)->elements[1];
...
c_73190.elements[0] = ((closureN)self_73101)->elements[0];
c_73190.elements[1] = ((closureN)self_73101)->elements[1];

return_closcall1(data,(closure)&c_73190,  Cyc_cdr(data, car(((closureN)self_73101)->elements[1])));; 
}

static void __lambda_10(void *data, int argc, object self_73102, object r_7367) {
  return_closcall1(data,  ((closureN)self_73102)->elements[0],  Cyc_set_cell(data, ((closureN)self_73102)->elements[1], r_7367));; 
}

static void __lambda_9(void *data, int argc, object self_73103, object k_7368) {
  if( (boolean_f != Cyc_is_null(Cyc_cdr(data, car(((closureN)self_73103)->elements[0])))) ){ 
...
c_73132.elements[0] = ((closureN)self_73104)->elements[0];
c_73132.elements[1] = ((closureN)self_73104)->elements[1];
...
c_73134.elements[0] = ((closureN)self_73105)->elements[1];
...
c_73147.elements[0] = ((closureN)self_73105)->elements[0];
c_73147.elements[1] = ((closureN)self_73105)->elements[1];
...
c_73149.elements[0] = ((closureN)self_73106)->elements[0];

return_closcall2(data,  __glo_error_91object_91irritants_scheme_base,  &c_73149, car(((closureN)self_73106)->elements[1]));; 
}
...
return_closcall2(data,  __glo_write_scheme_write,  &c_73154, o_7312_7323);; 
}

static void __lambda_3(void *data, int argc, object self_73109, object r_7353) {
  
make_utf8_string_with_len(c_73157, " ", 1, 1);
return_closcall2(data,  __glo_display_scheme_write,  ((closureN)self_73109)->elements[0], &c_73157);; 
}
...
return_closcall2(data,  __glo_error_91object_91irritants_scheme_base,  &c_73136, car(((closureN)self_73110)->elements[0]));; 
}
...
return_closcall2(data,  __glo_display_scheme_write,  ((closureN)self_73111)->elements[0], &c_73143);}
; 
}

static void __lambda_0(void *data, int argc, closure _,object k_7375) {
  Cyc_st_add(data, "scheme/repl.sld:interaction-environment");
return_closcall1(data,  __glo_setup_91environment_scheme_eval,  k_7375);; 
}
...
make_pair(c_73282, &pair_73274,Cyc_global_variables);
make_pair(c_73283, &pair_73277, &c_73282);
make_pair(c_73284, &pair_73279, &c_73283);
make_pair(c_73285, &pair_73281, &c_73284);
