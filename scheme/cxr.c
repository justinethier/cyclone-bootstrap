...
make_pair(pair_73606, find_or_add_symbol("caaaaar"), find_or_add_symbol("caaaaar__inline__"));
make_pair(c_73607, &pair_73606, NULL);
(((closure)cont)->fn)(data, 1, cont, &c_73607);
 } 
void c_schemecxr_entry_pt_first_lambda(data, argc, cont,value) void *data; int argc; closure cont; object value;{ 
  ...
  mclosure0(clo_73609, c_schemecxr_inlinable_lambdas); make_pair(pair_73608, find_or_add_symbol("c_schemecxr_inlinable_lambdas"), &clo_73609);
  make_cvar(cvar_73610, (object *)&__glo_lib_91init_117schemecxr_scheme_cxr);make_pair(pair_73611, find_or_add_symbol("lib-init:schemecxr"), &cvar_73610);
  make_cvar(cvar_73612, (object *)&__glo_caaaaar_191_191inline_191_191_scheme_cxr);make_pair(pair_73613, find_or_add_symbol("caaaaar__inline__"), &cvar_73612);
  make_cvar(cvar_73614, (object *)&__glo_caaaaar_scheme_cxr);make_pair(pair_73615, find_or_add_symbol("caaaaar"), &cvar_73614);
  make_cvar(cvar_73616, (object *)&__glo_cddddr_scheme_cxr);make_pair(pair_73617, find_or_add_symbol("cddddr"), &cvar_73616);
  make_cvar(cvar_73618, (object *)&__glo_cdddar_scheme_cxr);make_pair(pair_73619, find_or_add_symbol("cdddar"), &cvar_73618);
  make_cvar(cvar_73620, (object *)&__glo_cddadr_scheme_cxr);make_pair(pair_73621, find_or_add_symbol("cddadr"), &cvar_73620);
  make_cvar(cvar_73622, (object *)&__glo_cddaar_scheme_cxr);make_pair(pair_73623, find_or_add_symbol("cddaar"), &cvar_73622);
  make_cvar(cvar_73624, (object *)&__glo_cdaddr_scheme_cxr);make_pair(pair_73625, find_or_add_symbol("cdaddr"), &cvar_73624);
  make_cvar(cvar_73626, (object *)&__glo_cdadar_scheme_cxr);make_pair(pair_73627, find_or_add_symbol("cdadar"), &cvar_73626);
  make_cvar(cvar_73628, (object *)&__glo_cdaadr_scheme_cxr);make_pair(pair_73629, find_or_add_symbol("cdaadr"), &cvar_73628);
  make_cvar(cvar_73630, (object *)&__glo_cdaaar_scheme_cxr);make_pair(pair_73631, find_or_add_symbol("cdaaar"), &cvar_73630);
  make_cvar(cvar_73632, (object *)&__glo_cadddr_scheme_cxr);make_pair(pair_73633, find_or_add_symbol("cadddr"), &cvar_73632);
  make_cvar(cvar_73634, (object *)&__glo_caddar_scheme_cxr);make_pair(pair_73635, find_or_add_symbol("caddar"), &cvar_73634);
  make_cvar(cvar_73636, (object *)&__glo_cadadr_scheme_cxr);make_pair(pair_73637, find_or_add_symbol("cadadr"), &cvar_73636);
  make_cvar(cvar_73638, (object *)&__glo_cadaar_scheme_cxr);make_pair(pair_73639, find_or_add_symbol("cadaar"), &cvar_73638);
  make_cvar(cvar_73640, (object *)&__glo_caaddr_scheme_cxr);make_pair(pair_73641, find_or_add_symbol("caaddr"), &cvar_73640);
  make_cvar(cvar_73642, (object *)&__glo_caadar_scheme_cxr);make_pair(pair_73643, find_or_add_symbol("caadar"), &cvar_73642);
  make_cvar(cvar_73644, (object *)&__glo_caaadr_scheme_cxr);make_pair(pair_73645, find_or_add_symbol("caaadr"), &cvar_73644);
  make_cvar(cvar_73646, (object *)&__glo_caaaar_scheme_cxr);make_pair(pair_73647, find_or_add_symbol("caaaar"), &cvar_73646);
  make_cvar(cvar_73648, (object *)&__glo_cdddr_scheme_cxr);make_pair(pair_73649, find_or_add_symbol("cdddr"), &cvar_73648);
  make_cvar(cvar_73650, (object *)&__glo_cddar_scheme_cxr);make_pair(pair_73651, find_or_add_symbol("cddar"), &cvar_73650);
  make_cvar(cvar_73652, (object *)&__glo_cdadr_scheme_cxr);make_pair(pair_73653, find_or_add_symbol("cdadr"), &cvar_73652);
  make_cvar(cvar_73654, (object *)&__glo_cdaar_scheme_cxr);make_pair(pair_73655, find_or_add_symbol("cdaar"), &cvar_73654);
  make_cvar(cvar_73656, (object *)&__glo_caddr_scheme_cxr);make_pair(pair_73657, find_or_add_symbol("caddr"), &cvar_73656);
  make_cvar(cvar_73658, (object *)&__glo_cadar_scheme_cxr);make_pair(pair_73659, find_or_add_symbol("cadar"), &cvar_73658);
  make_cvar(cvar_73660, (object *)&__glo_caadr_scheme_cxr);make_pair(pair_73661, find_or_add_symbol("caadr"), &cvar_73660);
  make_cvar(cvar_73662, (object *)&__glo_caaar_scheme_cxr);make_pair(pair_73663, find_or_add_symbol("caaar"), &cvar_73662);
  make_cvar(cvar_73664, (object *)&__glo_cddr_scheme_cxr);make_pair(pair_73665, find_or_add_symbol("cddr"), &cvar_73664);
  make_cvar(cvar_73666, (object *)&__glo_cdar_scheme_cxr);make_pair(pair_73667, find_or_add_symbol("cdar"), &cvar_73666);
  make_cvar(cvar_73668, (object *)&__glo_cadr_scheme_cxr);make_pair(pair_73669, find_or_add_symbol("cadr"), &cvar_73668);
  make_cvar(cvar_73670, (object *)&__glo_caar_scheme_cxr);make_pair(pair_73671, find_or_add_symbol("caar"), &cvar_73670);
make_pair(c_73672, &pair_73608,Cyc_global_variables);
make_pair(c_73673, &pair_73611, &c_73672);
make_pair(c_73674, &pair_73613, &c_73673);
make_pair(c_73675, &pair_73615, &c_73674);
make_pair(c_73676, &pair_73617, &c_73675);
make_pair(c_73677, &pair_73619, &c_73676);
make_pair(c_73678, &pair_73621, &c_73677);
make_pair(c_73679, &pair_73623, &c_73678);
make_pair(c_73680, &pair_73625, &c_73679);
make_pair(c_73681, &pair_73627, &c_73680);
make_pair(c_73682, &pair_73629, &c_73681);
make_pair(c_73683, &pair_73631, &c_73682);
make_pair(c_73684, &pair_73633, &c_73683);
make_pair(c_73685, &pair_73635, &c_73684);
make_pair(c_73686, &pair_73637, &c_73685);
make_pair(c_73687, &pair_73639, &c_73686);
make_pair(c_73688, &pair_73641, &c_73687);
make_pair(c_73689, &pair_73643, &c_73688);
make_pair(c_73690, &pair_73645, &c_73689);
make_pair(c_73691, &pair_73647, &c_73690);
make_pair(c_73692, &pair_73649, &c_73691);
make_pair(c_73693, &pair_73651, &c_73692);
make_pair(c_73694, &pair_73653, &c_73693);
make_pair(c_73695, &pair_73655, &c_73694);
make_pair(c_73696, &pair_73657, &c_73695);
make_pair(c_73697, &pair_73659, &c_73696);
make_pair(c_73698, &pair_73661, &c_73697);
make_pair(c_73699, &pair_73663, &c_73698);
make_pair(c_73700, &pair_73665, &c_73699);
make_pair(c_73701, &pair_73667, &c_73700);
make_pair(c_73702, &pair_73669, &c_73701);
make_pair(c_73703, &pair_73671, &c_73702);
Cyc_global_variables = &c_73703;
