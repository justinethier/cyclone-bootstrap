...
void c_schemecxr_inlinable_lambdas(void *data, int argc, closure _, object cont){ 
  make_cvar(cvar_73606, (object *)&__glo_caaaaar_191_191inline_191_191_scheme_cxr);make_pair(pair_73607, find_or_add_symbol("caaaaar__inline__"), &cvar_73606);
make_pair(c_73608, &pair_73607, NULL);
(((closure)cont)->fn)(data, 1, cont, &c_73608);
 } 
void c_schemecxr_entry_pt_first_lambda(data, argc, cont,value) void *data; int argc; closure cont; object value;{ 
  ...
  mclosure0(clo_73610, c_schemecxr_inlinable_lambdas); make_pair(pair_73609, find_or_add_symbol("c_schemecxr_inlinable_lambdas"), &clo_73610);
  make_cvar(cvar_73611, (object *)&__glo_lib_91init_117schemecxr_scheme_cxr);make_pair(pair_73612, find_or_add_symbol("lib-init:schemecxr"), &cvar_73611);
  make_cvar(cvar_73613, (object *)&__glo_caaaaar_191_191inline_191_191_scheme_cxr);make_pair(pair_73614, find_or_add_symbol("caaaaar__inline__"), &cvar_73613);
  make_cvar(cvar_73615, (object *)&__glo_caaaaar_scheme_cxr);make_pair(pair_73616, find_or_add_symbol("caaaaar"), &cvar_73615);
  make_cvar(cvar_73617, (object *)&__glo_cddddr_scheme_cxr);make_pair(pair_73618, find_or_add_symbol("cddddr"), &cvar_73617);
  make_cvar(cvar_73619, (object *)&__glo_cdddar_scheme_cxr);make_pair(pair_73620, find_or_add_symbol("cdddar"), &cvar_73619);
  make_cvar(cvar_73621, (object *)&__glo_cddadr_scheme_cxr);make_pair(pair_73622, find_or_add_symbol("cddadr"), &cvar_73621);
  make_cvar(cvar_73623, (object *)&__glo_cddaar_scheme_cxr);make_pair(pair_73624, find_or_add_symbol("cddaar"), &cvar_73623);
  make_cvar(cvar_73625, (object *)&__glo_cdaddr_scheme_cxr);make_pair(pair_73626, find_or_add_symbol("cdaddr"), &cvar_73625);
  make_cvar(cvar_73627, (object *)&__glo_cdadar_scheme_cxr);make_pair(pair_73628, find_or_add_symbol("cdadar"), &cvar_73627);
  make_cvar(cvar_73629, (object *)&__glo_cdaadr_scheme_cxr);make_pair(pair_73630, find_or_add_symbol("cdaadr"), &cvar_73629);
  make_cvar(cvar_73631, (object *)&__glo_cdaaar_scheme_cxr);make_pair(pair_73632, find_or_add_symbol("cdaaar"), &cvar_73631);
  make_cvar(cvar_73633, (object *)&__glo_cadddr_scheme_cxr);make_pair(pair_73634, find_or_add_symbol("cadddr"), &cvar_73633);
  make_cvar(cvar_73635, (object *)&__glo_caddar_scheme_cxr);make_pair(pair_73636, find_or_add_symbol("caddar"), &cvar_73635);
  make_cvar(cvar_73637, (object *)&__glo_cadadr_scheme_cxr);make_pair(pair_73638, find_or_add_symbol("cadadr"), &cvar_73637);
  make_cvar(cvar_73639, (object *)&__glo_cadaar_scheme_cxr);make_pair(pair_73640, find_or_add_symbol("cadaar"), &cvar_73639);
  make_cvar(cvar_73641, (object *)&__glo_caaddr_scheme_cxr);make_pair(pair_73642, find_or_add_symbol("caaddr"), &cvar_73641);
  make_cvar(cvar_73643, (object *)&__glo_caadar_scheme_cxr);make_pair(pair_73644, find_or_add_symbol("caadar"), &cvar_73643);
  make_cvar(cvar_73645, (object *)&__glo_caaadr_scheme_cxr);make_pair(pair_73646, find_or_add_symbol("caaadr"), &cvar_73645);
  make_cvar(cvar_73647, (object *)&__glo_caaaar_scheme_cxr);make_pair(pair_73648, find_or_add_symbol("caaaar"), &cvar_73647);
  make_cvar(cvar_73649, (object *)&__glo_cdddr_scheme_cxr);make_pair(pair_73650, find_or_add_symbol("cdddr"), &cvar_73649);
  make_cvar(cvar_73651, (object *)&__glo_cddar_scheme_cxr);make_pair(pair_73652, find_or_add_symbol("cddar"), &cvar_73651);
  make_cvar(cvar_73653, (object *)&__glo_cdadr_scheme_cxr);make_pair(pair_73654, find_or_add_symbol("cdadr"), &cvar_73653);
  make_cvar(cvar_73655, (object *)&__glo_cdaar_scheme_cxr);make_pair(pair_73656, find_or_add_symbol("cdaar"), &cvar_73655);
  make_cvar(cvar_73657, (object *)&__glo_caddr_scheme_cxr);make_pair(pair_73658, find_or_add_symbol("caddr"), &cvar_73657);
  make_cvar(cvar_73659, (object *)&__glo_cadar_scheme_cxr);make_pair(pair_73660, find_or_add_symbol("cadar"), &cvar_73659);
  make_cvar(cvar_73661, (object *)&__glo_caadr_scheme_cxr);make_pair(pair_73662, find_or_add_symbol("caadr"), &cvar_73661);
  make_cvar(cvar_73663, (object *)&__glo_caaar_scheme_cxr);make_pair(pair_73664, find_or_add_symbol("caaar"), &cvar_73663);
  make_cvar(cvar_73665, (object *)&__glo_cddr_scheme_cxr);make_pair(pair_73666, find_or_add_symbol("cddr"), &cvar_73665);
  make_cvar(cvar_73667, (object *)&__glo_cdar_scheme_cxr);make_pair(pair_73668, find_or_add_symbol("cdar"), &cvar_73667);
  make_cvar(cvar_73669, (object *)&__glo_cadr_scheme_cxr);make_pair(pair_73670, find_or_add_symbol("cadr"), &cvar_73669);
  make_cvar(cvar_73671, (object *)&__glo_caar_scheme_cxr);make_pair(pair_73672, find_or_add_symbol("caar"), &cvar_73671);
make_pair(c_73673, &pair_73609,Cyc_global_variables);
make_pair(c_73674, &pair_73612, &c_73673);
make_pair(c_73675, &pair_73614, &c_73674);
make_pair(c_73676, &pair_73616, &c_73675);
make_pair(c_73677, &pair_73618, &c_73676);
make_pair(c_73678, &pair_73620, &c_73677);
make_pair(c_73679, &pair_73622, &c_73678);
make_pair(c_73680, &pair_73624, &c_73679);
make_pair(c_73681, &pair_73626, &c_73680);
make_pair(c_73682, &pair_73628, &c_73681);
make_pair(c_73683, &pair_73630, &c_73682);
make_pair(c_73684, &pair_73632, &c_73683);
make_pair(c_73685, &pair_73634, &c_73684);
make_pair(c_73686, &pair_73636, &c_73685);
make_pair(c_73687, &pair_73638, &c_73686);
make_pair(c_73688, &pair_73640, &c_73687);
make_pair(c_73689, &pair_73642, &c_73688);
make_pair(c_73690, &pair_73644, &c_73689);
make_pair(c_73691, &pair_73646, &c_73690);
make_pair(c_73692, &pair_73648, &c_73691);
make_pair(c_73693, &pair_73650, &c_73692);
make_pair(c_73694, &pair_73652, &c_73693);
make_pair(c_73695, &pair_73654, &c_73694);
make_pair(c_73696, &pair_73656, &c_73695);
make_pair(c_73697, &pair_73658, &c_73696);
make_pair(c_73698, &pair_73660, &c_73697);
make_pair(c_73699, &pair_73662, &c_73698);
make_pair(c_73700, &pair_73664, &c_73699);
make_pair(c_73701, &pair_73666, &c_73700);
make_pair(c_73702, &pair_73668, &c_73701);
make_pair(c_73703, &pair_73670, &c_73702);
make_pair(c_73704, &pair_73672, &c_73703);
Cyc_global_variables = &c_73704;
