...
static void __lambda_1(int argc, object self_7320, object r_736) ;
static void __lambda_0(int argc, object self_7321, object r_737) ;
...
make_int(c_7352, 0);
return_closcall1((closure)&c_7325,  &c_7352);; 
}
...
object c_7349 = Cyc_string_append((closure)&c_7327, 3,&c_7350, __glo__85version_85, &c_7351);
return_closcall1((closure)&c_7327,  c_7349);; 
}
...
return_closcall1((closure)&c_7329,  global_set(__glo__85version_91banner_85, r_738));; 
}
...
return_closcall1((closure)&c_7331,  global_set(__glo__85Cyc_91version_91banner_85, __glo__85version_91banner_85));; 
}
...
object c_7340 = Cyc_string_append((closure)&c_7333, 3,&c_7341, __glo__85version_85, &c_7342);
return_closcall1((closure)&c_7333,  c_7340);; 
}

static void __lambda_0(int argc, object self_7321, object r_737) {
  Cyc_st_add("scheme/cyclone/common.sld:lib-init:schemecyclonecommon");
return_closcall1(  ((closureN)self_7321)->elts[0],  global_set(__glo__85c_91file_91header_91comment_85, r_737));; 
}
