...
make_string(c_73211, "ast:set-lambda-body!");
...
return_closcall1(data,(closure)&c_73177,  global_set(__glo_ast_117set_91lambda_91body_67_scheme_cyclone_ast, r_7330));; 
}
...
return_closcall3(data,  __glo_ast_117set_91lambda_91body_67_scheme_cyclone_ast,  &c_73191, res_736, ((closureN)self_73100)->elements[1]);; 
}
...
void c_schemecycloneast_entry_pt(data, argc, cont,value) void *data; int argc; closure cont; object value;{ 
  ...
  make_cvar(cvar_73237, (object *)&__glo_ast_117set_91lambda_91body_67_scheme_cyclone_ast);make_pair(pair_73238, find_or_add_symbol("ast:set-lambda-body!"), &cvar_73237);
